...
class MyNet:
  ...
  def train(self,Lr=0.01, Decay=1e-6, Momentum=0.9,batch_size=128, epochs=12):
    ...
    self.model.add(Conv2D(filters=8,activation='relu', input_shape=input_shape,padding='valid',kernel_size=(3,3)))
    self.model.add(Conv2D(filters=16, activation='relu',padding='valid',kernel_size=(2,2)))
    self.model.add(Conv2D(filters=32, activation='relu',padding='valid',kernel_size=(2,2)))
    self.model.add(MaxPooling2D(pool_size=(2, 2)))

    self.model.add(Conv2D(filters=64,activation='relu',padding='valid',kernel_size=(3,3)))
    self.model.add(Conv2D(filters=128, activation='relu',padding='valid',kernel_size=(2,2)))
    self.model.add(Conv2D(filters=256, activation='relu',padding='valid',kernel_size=(2,2)))
